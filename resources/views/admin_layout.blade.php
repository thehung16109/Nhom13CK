        ...
        <div class="leftside-navigation">
            <ul class="sidebar-menu" id="nav-accordion">
                ...
                <li class="sub-menu">
                    <a href="javascript:;">
                        <i class="fa fa-book"></i>
                        <span>Danh mục voucher</span>
                    </a>
                    <ul class="sub">
						<li><a href="{{URL::to('/add-category-product')}}">Thêm danh mục voucher</a></li>
						<li><a href="{{URL::to('/all-category-product')}}">Liệt kê danh mục voucher</a></li>
                ...
                <li class="sub-menu">
                    <a href="javascript:;">
                        <i class="fa fa-book"></i>
                        <span>Nhà cung cấp voucher</span>
                    </a>
                    <ul class="sub">
                ...
                <li class="sub-menu">
                    ...
                    <ul class="sub">
						<li><a href="{{URL::to('/add-product')}}">Thêm voucher</a></li>
						<li><a href="{{URL::to('/all-product')}}">Liệt kê voucher</a></li>

                    ...
                    <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
                        <div class="menu_section">
                            <ul class="nav side-menu">
                                <li><a a href="{{ URL::to('/trang-chu') }}"><i class="fa fa-home"></i> Trang chủ </a>
                                </li>
                                ...
                                <li><a><i class="fa fa-map-marker"></i>Địa điểm<span
                                    ...
                                    <ul class="nav child_menu">
                                        ...
                                        <li><a href="{{ URL::to('/all-location') }}">Liệt kê điạ điểm</a></li>
                                    </ul>
                                </li>
                                <li><a><i class="fa fa-edit"></i>Bài review<span class="fa fa-chevron-down"></span></a>
                                    <ul class="nav child_menu">
                                        <li><a href="{{ URL::to('/add-review') }}">Thêm bài review</a></li>
                                        <li><a href="{{ URL::to('/all-review') }}">Liệt kê bài review</a></li>
                                    </ul>
                                </li>
                                <li><a><i class="fa fa-edit"></i>Danh mục bài review<span
                                            class="fa fa-chevron-down"></span></a>
                                    <ul class="nav child_menu">
                        ...
                        <ul class=" navbar-right">
                            <li class="nav-item dropdown open" style="padding-left: 15px;">
                                ...
                                <div class="dropdown-menu dropdown-usermenu pull-right"
                                    ...
                                    <a class="dropdown-item" href="{{ URL::to('/logout1') }}"><i

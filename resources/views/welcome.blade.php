                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav mr-auto mb-2 mb-lg-0">
                        <li class="nav-item active">
                            <a class="nav-link" href="./home.html" style="color: #f68a39;">Trang chủ <span
        ...
        <div class="container px-0">
            <div class="row container px-0 mx-0">
                <div class="col-md-6 col-lg-6 col-xl-6 carousel-left item p-0 ">
                    <img src="../images/CardHomestay/1.jpeg" alt="">
                ...
                <div class="col-md-6 col-lg-6 col-xl-6 carousel-right">
                    <div class="row">
                        <div class="col-md-6 col-lg-6 col-xl-6 item p-0">
                            <img src="../images/carousel/105625437_1120271368359451_2399958823443664218_n-357x210.jpeg"
                                alt="">
                        ...
                        <div class="col-md-6 col-lg-6 col-xl-6 item p-0 ">
                            <img src="../images/carousel/2-16482-357x210.jpeg" alt="">
                            <div class="carousel-overlay">
                    ...
                    <div class="row">
                        <div class="col-md-6 col-lg-6 col-xl-6 item p-0">
                            <img src="../images/carousel/aa-16204-357x210.jpeg" alt="">
                            <div class="carousel-overlay">
                                <h6 class="p-0">HomeStay</h6>
                            </div>
                        </div>
                        <div class="col-md-6 col-lg-6 col-xl-6 item p-0 ">
                            <img src="../images/carousel/159512764_1342217616135054_2705855460809883874_n-357x210.jpeg"
                                alt="">
                            <div class="carousel-overlay">
        ...
        <div class="container">
            ...
            <div class="row mt-3">
                <div class="col-md-3 col-lg-3 col-xl-3">
                    <div class="row">
                        <a href="">
                            <img class="myimg" src="../images/Trangchu/10.jpeg" alt="">
                        </a>
                        <a class="titleimg mt-1" href="">Ghé Ecofarm Gia Trịnh Ba Vì Trải Nghiệm Du Lịch…</a>
                    </div>
                    <div class="row mt-2">
                        <a href="">
                            <img class="myimg" src="../images/Trangchu/11.jpeg" alt="">
                        </a>
                ...
                <div class="col-md-6 col-lg-6 col-xl-6">
                    <div class="mt-5">
                        <a href="">
                            <img class="myimg1" src="../images/Trangchu/14.jpeg" alt="">
                        </a>
                ...
                <div class="col-md-3 col-lg-3 col-xl-3">
                    <div class="row">
                        <a href="">
                            <img class="myimg" src="../images/Trangchu/12.jpg" alt="">
                        </a>
                    ...
                    <div class="row mt-2">
                        <a href="">
                            <img class="myimg" src="../images/Trangchu/13.png" alt="">
                        </a>
    ...
    <section class="list-lastest-post mt-5">
        <div class="container px-0">
            ...
            <div class="row mt-2">
                <div class="col-md-4 col-lg-4 col-xl-4">
                    <a href="">
                        <img class="myimg" src="../images/Lastest post/4.jpg" alt="">
                    </a>
                    <a class="titleimg mt-5" href="">Homestay Tam Đảo “Giá Rẻ”, Làm Việc Thiếu Chuyên Nghiệp!</a>
                </div>
                <div class="col-md-4 col-lg-4 col-xl-4">
                    <a href="">
                        <img class="myimg" src="../images/Lastest post/5.jpg" alt="">
                    </a>
                    <a class="titleimg mt-5" href="">Stella Mộc Châu – Homestay Sắc Màu</a>
                </div>
                <div class="col-md-4 col-lg-4 col-xl-4">
                    <a href="">
                        <img class="myimg" src="../images/Lastest post/6.jpg" alt="">
                    </a>
            ...
            <div class="row text-center text-md-left">
                ...
                <div class="col-md-4 col-lg-4 col-xl-4">
                    ...
                    <div class="row footer-item">
                        <div class="col-md-3">
                            <img src="../images/footer/1.jpeg" alt="">
                        </div>

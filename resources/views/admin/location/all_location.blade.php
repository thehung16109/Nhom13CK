                            ...
                            @foreach ($all_location as $key => $location)
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a href="{{URL::to('/unactive-location/'.$location->location_id)}}"><span class="fa-eye-slash-style fa fa-eye-slash"></span></a>
                                        <?php } else { ?>
                                        <a href="{{URL::to('/active-location/'.$location->location_id)}}"><span class="fa-eye-style fa fa-eye"></span></a>
                                        <?php } ?>
                                    </td>
                                    <td>

                            ...
                            @foreach ($all_review as $key => $review)
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a href="{{URL::to('/unactive-review1/'.$review->review_id)}}"><span class="fa-eye-slash-style fa fa-eye-slash"></span></a>
                                        <?php } else { ?>
                                        <a href="{{URL::to('/active-review1/'.$review->review_id)}}"><span class="fa-eye-style fa fa-eye"></span></a>
                                        <?php } ?>
                                    </td>
                                    <td>
                                        <a href="{{URL::to('/edit-review1/'.$review->review_id)}}">
                                            <i class="fa fa-pencil-square-o text-success text-active" style="font-size: 20px"></i>
                                        </a>
                                        <a onclick="return confirm('Bạn chắc chắn muốn xóa bài viết này?')" href="{{URL::to('/delete-review1/'.$review->review_id)}}">
